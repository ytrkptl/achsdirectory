...
const AboutCard = () => {
  return (
    <div style={{ marginLeft: "10px", marginRight: "10px" }}>
      <p className="AboutCard">You might be wondering what ACHS stands for?</p>
      ...
      <p className="AboutCard">
        Oh yeah, and don't forget to toggle animation on at the top right of
        this page and play with our school mascots that fly around.
      </p>
      <p className="AboutCard" style={{ color: "#74b9ff" }}>
        Is our mascot hippos or cows? I cannot tell, can you? Anyways, have fun.
      </p>
      <h4 className="AboutCard">"Go Hippos" or "Go Cows"??</h4>
      <p className="AboutCard" style={{ color: "#74b9ff" }}>
        Okay
      </p>
    </div>
